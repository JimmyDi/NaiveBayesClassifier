...
%     for i=1:number_70_positive
%         split_70_positive(i,:)=data_positive(p_70(i),:)
%     end
%     for i=1:number_30_positive
%         split_30_positive(i,:)=data_positive(p_30(i),:);
%     end
    for i=1:number_30_positive
        split_30_positive(i,:)=data_positive(find(data_positive(:,1)==p_30(i)),:);
        data_positive(find(data_positive(:,1)==p_30(i)),:)=[];
    end
%         split_30_positive=sortrow(split_30_positive,1);
...
%         split_30_negative=sortcol(split_30_negative,1);
        split_70_negative=data_negative;
%     split_70_positive=data_positive;
% %     for i=1:number_70_negative
% %         split_70_negative(i,:)=data_negative(n_70(i),:)
% %     end
%     for i=1:number_30_negative
%         split_30_negative(i,:)=data_negative(n_30(i),:);
%     end
%     for i=1:number_30_negative
%         data_negative(n_30(i),:)=[];
%     end
%      split_70_negative=data_negative;
